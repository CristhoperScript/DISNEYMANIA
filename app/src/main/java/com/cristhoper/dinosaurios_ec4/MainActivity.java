...
import com.cristhoper.dinosaurios_ec4.api.ApiService;
import com.cristhoper.dinosaurios_ec4.models.Item;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "DISNEYMANIA";
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.CerrarSesion){
            ...
            builder.setMessage("¿Estas seguro que quieres salir?").setPositiveButton("Si", new DialogInterface.OnClickListener() {
                @Override
